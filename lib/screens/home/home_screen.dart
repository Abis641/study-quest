          ...
          Row(
            children: [
              SubjectCard(
                ...
                onTap: () => context.push('${AppRoutes.subject}/math'),
              ...
              SubjectCard(
                ...
                onTap: () => context.push('${AppRoutes.subject}/science'),
                focusNode: _scienceFocus,
              ).animate().fadeIn(delay: 150.ms).slideY(begin: 0.2),
              const SizedBox(width: 16),
              SubjectCard(
                subject: SubjectData.all[2],
                onTap: () => context.push('${AppRoutes.subject}/english'),
                focusNode: _englishFocus,
              ).animate().fadeIn(delay: 200.ms).slideY(begin: 0.2),
              const SizedBox(width: 16),
              SubjectCard(
                subject: SubjectData.all[3],
                onTap: () => context.push('${AppRoutes.subject}/geography'),
                focusNode: _geoFocus,
...
class _DailyTipCard extends StatelessWidget {
  static const _tips = [
    ...
    '🧠 Sleep helps your brain store memories — always get a good night\'s rest!',
    '⚡ Short study sessions with breaks are more effective than long cramming sessions!',
